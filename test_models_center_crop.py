...
# options
parser = argparse.ArgumentParser(description="STME testing on the full validation set")
...
parser.add_argument('--output_dir',type=str,default="./pkl_path",help='directory for pkl')
